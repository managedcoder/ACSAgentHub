...
using VATemplateExample.Adapters;
using VATemplateExample.Authentication;
using VATemplateExample.Bots;
...
namespace VATemplateExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(sp => new AuthenticationConfiguration { ClaimsValidator = new VATemplateExample.Authentication.AllowedCallersClaimsValidator(skillsConfig) });
            ...
            // Use the following option if you see this error: "The request failed because the client was unable to establish connections to 4 endpoints across 1 regions. Please check for client resource starvation issues and verify connectivity between client and server.
            settings.CosmosDb.CosmosClientOptions = new Microsoft.Azure.Cosmos.CosmosClientOptions() { ConnectionMode = Microsoft.Azure.Cosmos.ConnectionMode.Gateway };
            ...
            services.AddSingleton<SkillConversationIdFactoryBase, Microsoft.Bot.Solutions.Skills.SkillConversationIdFactory>();
            ...
            services.AddSingleton<TranscriptLoggingMiddleware>();
            ACSAgentHubConfig acsAgentHubConfig = Configuration.GetSection(ACSAgentHubConfig.Section)?.Get<ACSAgentHubConfig>();
            services.AddHttpClient<AgentHubHttpClient>(client =>
            {
                client.BaseAddress = new Uri(acsAgentHubConfig.acsAgentHubBaseAddress);
